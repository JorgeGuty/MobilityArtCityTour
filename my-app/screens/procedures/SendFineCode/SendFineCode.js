import { StyleSendCode } from './SendFineCode.style'
  ...
  return (
    <ScreenProcedureStructure titleText={i18n.t('CONSULT_FINE')} navigation={navigation} onPressBackButton={() => navigation.goBack()}>
      ...
      {Constants.sendCodeOptionsTest
        ...
        : null}
      <NButton setEditable style={StyleSendCode.button} onPress={() => { navigation.navigate('VerifyFineCode') }}>
