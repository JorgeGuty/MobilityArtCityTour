import { StyleSendCode } from './SendSpeedCode.style'
...
/*
  ...
  <SendSpeedCode />
*/
const SendSpeedCode = ({ navigation }) => {
  const [selectedOption, setSelectedOption] = useState(0)

  return (
    <ScreenProcedureStructure titleText={i18n.t('INITIALCONSULT_TITLE2')} navigation={navigation} onPressBackButton={() => navigation.goBack()}>
      ...
      {Constants.sendCodeOptionsTest
        ...
        : null}
      <NButton setEditable style={StyleSendCode.button} onPress={() => { navigation.navigate('VerifySpeedCode') }}>
